...
f_1 := x^36 + 5*x^31 + 6*x^30*y + 6*x^30 + 4*x^26 + 4*x^25*y + 4*x^25 + x^24*y^2 + 
    2*x^24*y + x^24 + 6*x^21 + 2*x^20*y + 2*x^20 + x^19*y^2 + 2*x^19*y + x^19 + 
    6*x^18*y^3 + 4*x^18*y^2 + 4*x^18*y + 6*x^18 + 2*x^16 + 4*x^15*y + 4*x^15 + 
    3*x^14*y^2 + 6*x^14*y + 3*x^14 + x^13*y^3 + 3*x^13*y^2 + 3*x^13*y + x^13 + 
    x^12*y^4 + 4*x^12*y^3 + 6*x^12*y^2 + 4*x^12*y + x^12 + x^11 + 3*x^10*y + 
    3*x^10 + 4*x^9*y^2 + x^9*y + 4*x^9 + 2*x^8*y^3 + 6*x^8*y^2 + 6*x^8*y + 2*x^8
    + 4*x^7*y^4 + 2*x^7*y^3 + 3*x^7*y^2 + 2*x^7*y + 6*x^7 + 6*x^6*y^5 + 
    2*x^6*y^4 + 4*x^6*y^3 + 4*x^6*y^2 + 3*x^6*y + 2*x^6 + 5*x^5*y + 4*x^5 + 
    x^4*y^2 + 5*x^4*y + 4*x^4 + 6*x^3*y^3 + 4*x^3*y^2 + 4*x^3*y + 6*x^3 + 
    4*x^2*y^4 + 2*x^2*y^3 + 3*x^2*y^2 + 2*x^2*y + 4*x^2 + 5*x*y^5 + 4*x*y^4 + 
    x*y^3 + x*y^2 + 4*x*y + 5*x + y^6 + 6*y^5 + y^4 + 6*y^3 + y^2 + 6*y + 1;
...
f_2 := x^36 + 6*x^35 + 15*x^34 + x^33 + 15*x^32 + 12*x^31 + 6*x^30*y + 5*x^30 + 11*x^29*y + 6*x^29 + 3*x^28*y + 9*x^28 + 3*x^27*y + 17*x^27 + 11*x^26*y + 5*x^26 + 17*x^25*y + 18*x^25 + 15*x^24*y^2 + 9*x^24*y + 10*x^24 + 3*x^23*y^2 + 2*x^23*y + 14*x^23 + 14*x^22*y^2 + 5*x^22*y + 7*x^22 + 3*x^21*y^2 + 4*x^21*y + 16*x^21 + 15*x^20*y^2 + 6*x^20*y + 12*x^20 + 3*x^19*y^2
...
f_4 := 3*x^35 + 3*x^34 + 3*x^33 + 2*x^32 + 3*x^30*y + 2*x^30 + 4*x^29*y + 4*x^29 + 3*x^28*y + 3*x^28 + 2*x^27*y + 2*x^27 + 2*x^25*y^2 + x^25*y + 2*x^24*y + 3*x^24 + 4*x^23*y + x^22*y + x^20*y^2 + 4*x^20*y + 4*x^20 + 4*x^19*y + 2*x^19 + 3*x^18*y + x^18 + 2*x^17*y + 4*x^17 + 2*x^15*y^2 + 4*x^15*y + x^14*y + 2*x^13*y + x^13 + 3*x^12*y + 4*x^12 + 2*x^11 + 4*x^10*y^5 + 
    3*x^10*y^2 + 3*x^10*y + 2*x^10 + 4*x^9*y^5 + 4*x^9 + 4*x^8*y^5 + x^7*y^5 + 2*x^7 + 3*x^6*y + 2*x^6 + 4*x^5*y^6 + 4*x^5*y^5 + 4*x^5*y + 2*x^5 + 2*x^4*y^6 + 3*x^4 + 4*x^3*y^6 + 2*x^3*y^5 + 3*x^3*y + x^2*y^6 + 3*x^2*y^5 + 2*x^2*y + x^2 + x*y^2 + 3*x*y + y^7 + y^6 + 4*y^5 + 3*y^2 + 3*y + 2;
...
f_5 := 7*x^35 + 8*x^34 + 9*x^33 + x^32 + 3*x^31 + 8*x^30*y + 4*x^30 + 2*x^29*y + 7*x^29 + 10*x^28*y + 7*x^28 + 3*x^27*y + 4*x^27 + 4*x^26*y + 7*x^26 + x^25*y^2 + 4*x^25*y + 2*x^25 + 8*x^24*y^2 + x^24*y + 6*x^24 + 5*x^23*y^2 + 7*x^23*y + 9*x^22*y^2 + 3*x^22 + 10*x^21*y^2 + 4*x^21*y + 10*x^20*y^3 + 6*x^20*y^2 + 10*x^20*y + 4*x^20 + 9*x^19*y^3 + 9*x^19*y^2 + 7*x^19*y 
    + 7*x^19 + 2*x^18*y^3 + x^18*y^2 + 3*x^18*y + 10*x^18 + 2*x^17*y^3 + 9*x^17*y^2 + 6*x^17 + 10*x^16*y^3 + 8*x^16*y^2 + 9*x^16*y + 5*x^16 + 5*x^15*y^4 + 6*x^15*y^3 + 3*x^15*y^2 + 5*x^15 + 2*x^14*y^4 + 8*x^14*y^3 + 8*x^14*y^2 + 4*x^14*y + 5*x^14 + 3*x^13*y^4 + 3*x^13*y^2 + x^13*y + 8*x^13 + 4*x^12*y^4 + 6*x^12*y^3 + 3*x^12*y^2 + 2*x^12*y + 4*x^12 + 
    7*x^11*y^4 + 7*x^11*y^3 + 4*x^11*y^2 + 8*x^11*y + 10*x^11 + 7*x^10*y^5 + x^10*y^4 + 9*x^10*y^3 + 3*x^10*y^2 + 7*x^10*y + 4*x^10 + 7*x^9*y^5 + 8*x^9*y^4 + 5*x^9*y^3 + 7*x^9*y^2 + 4*x^9*y + x^9 + 6*x^8*y^5 + 2*x^8*y^4 + x^8*y^3 + 3*x^8*y^2 + 10*x^8*y + 10*x^8 + 9*x^7*y^5 + 3*x^7*y^4 + 7*x^7*y^3 + 10*x^7*y^2 + 4*x^7*y + 7*x^7 + 10*x^6*y^5 + 7*x^6*y^4 + 
    9*x^6*y^3 + 5*x^6*y^2 + 8*x^6*y + 2*x^6 + 3*x^5*y^6 + 10*x^5*y^5 + 9*x^5*y^4 + 3*x^5*y^3 + 4*x^5*y^2 + 6*x^5 + 7*x^4*y^6 + 5*x^4*y^5 + 10*x^4*y^4 + 7*x^4*y^3 + 2*x^4*y^2 + 2*x^4*y + 7*x^3*y^6 + 5*x^3*y^5 + 10*x^3*y^4 + 7*x^3*y^3 + 2*x^3*y^2 + 9*x^3*y + 10*x^3 + 7*x^2*y + 10*x^2 + 2*x*y^2 + x*y + 7*x + y^7 + 10*y^6 + 2*y^5 + 10*y^4 + 8*y^3 + 10*y^2 + 10*y
    + 9;
